                ...
                <div className="container">
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-6  aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <img src="assets/img/tilt1.png" className="img-fluid rounded-4" alt="Shree Harikrishna Alluminium" />
                        ...
                        <div className="col-lg-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="250">
                            <div className="content ps-0 ps-lg-5">
                                <p className="fst-italic">
                                    <h3>Shree Harikrishna Aluminium specializes</h3> the aluminium Tilt &
                                    Slide window system combines modern design with versatile functionality.
                                    These innovative windows offer dual operation—tilting inward at the top for
                                    secure ventilation and sliding horizontally for full opening—making them perfect
                                    for both safety and convenience. Engineered with precision hardware and high-quality
                                    aluminum profiles, Tilt & Slide windows are ideal for spaces requiring flexible airflow and
                                    ease of access without compromising on aesthetics or security.</p>
                                {/* <ul>
...
Known for our excellent service and skilled workmanship, our team is dedicated, experienced, and customer-friendly. We handle all types of aluminium work with precision and care, delivering results that meet the highest standards. Our brand is widely recognized in the market for its reliability, durability, and elegant designs. At Shree Harikrishna Aluminium, we turn your vision into lasting, functional beauty with trust and quality you can count on.
                                ...
                                <div className="position-relative mt-6">
                                    <img src="assets/img/tilt2.png" className="img-fluid rounded-8" alt="Shree Harikrishna Alluminium" />
                                </div>
                            </div>
                        </div>
                    </div>
