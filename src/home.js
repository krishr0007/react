      ...
      <div class="container py-10 features">
        <ul class="nav nav-tabs row d-flex aos-init aos-animate" data-aos="fade-up" data-aos-delay="100" role="tablist">
          <li class="nav-item col-3" role="presentation">
            <a href='/#' class="nav-link show" data-bs-toggle="tab" data-bs-target="#features-tab-1" aria-selected="false" role="tab" tabindex="-1">
              <i class="bi bi-binoculars"></i>
              <h4 class="d-none d-lg-block">Window's</h4>
            </a>
          </li>
          <li class="nav-item col-3" role="presentation">
            <a href='/#' class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-2" aria-selected="false" role="tab" tabindex="-1">
              <i class="bi bi-box-seam"></i>
              <h4 class="d-none d-lg-block">Door's</h4>
            </a>
          </li>
          <li class="nav-item col-3" role="presentation">
            <a href='/#' class="nav-link active" data-bs-toggle="tab" data-bs-target="#features-tab-3" aria-selected="true" role="tab">
              <i class="bi bi-brightness-high"></i>
              <h4 class="d-none d-lg-block">kitchen Cabninet</h4>
            </a>
          </li>
          <li class="nav-item col-3" role="presentation">
            <a href='/#' class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-4" aria-selected="false" role="tab" tabindex="-1">
