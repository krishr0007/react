      ...
      <div className="container">
        <div className="row gy-4">
          ...
          <div className="col-lg-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            ...
            <img src="assets/img/1.jpg" className="img-fluid rounded-4 mb-4 imgg" alt="Shree Harikrishna Alluminium" />
          ...
          <div className="col-lg-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="250">
            <div className="content ps-0 ps-lg-5">
              ...
              <div className="position-relative mt-4">
                <img src="assets/img/2.jpg" className="img-fluid rounded-4" alt="Shree Harikrishna Alluminium" />
              </div>
            </div>
          </div>
        </div>
